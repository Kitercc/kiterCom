...
const LczNightingale = LczChart.LczChartPie.LczNightingale

export const T_LczNightingale = memo(function T_LczNightingale() {
  const c = {
    selected: 'gradient',
  ...
  const config: LczBasicPieProps = {
    ...
    seriesConfig: {
      ...
      visualMap: {
        ...
        max: 999,
        min: 40,
        color: [{ value: '#c23531' }, { value: '#1fd2ff' }],
        colorLightnessMin: 0,
  ...
  return (
    <div style={{ width: 900, height: 600 }}>
      <LczNightingale w={900} h={600} data={data} {...config} onClick={a => console.log(a)} />
    </div>
  )
})
