...
const LczScatter = LczChart.LczChartScatter.LczBasicScatter
...
export const T_LczScatter = memo(function T_LczScatter() {
  ...
  return (
    <div style={{ width: 600, height: 400 }}>
      ...
      {show && <LczScatter {...config} w={600} h={400} data={data} onClick={a => console.log(a)} />}
    </div>
  )
})
