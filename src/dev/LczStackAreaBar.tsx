...
const LczStackAreaBar = LczChart.LczChartBlend.LczStackAreaBar

export const T_LczStackAreaBar = memo(function T_LczBasicStackAreaBar() {
  const c = {
    selected: 'single',
  ...
  const config: LineBarProps = {
    ...
    seriesConfig: {
      ...
      markPointSeries: [],
      stackSeries: [
        { stackName: 'to', seriesName: '增长率,系列一,出生率,出生率1' }
        // { stackName: '1', seriesName: '出生率,出生率1' }
      ]
    },
    tooltipConfig: {
  ...
  return (
    <div style={{ width: 900, height: 600, margin: ' 0 auto' }}>
      ...
      {show && <LczStackAreaBar w={900} h={600} {...config} data={data} onClick={a => console.log(a)} />}
    </div>
  )
})
