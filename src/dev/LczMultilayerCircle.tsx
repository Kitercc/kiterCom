...
import { MultilayerCircleProps } from '../LczChart/LczChartPie/LczMultilayerCircle/type'

const LczMultilayerCircle = LczChart.LczChartPie.LczMultilayerCircle

export const T_LczMultilayerCircle = memo(function T_LczMultilayerCircle() {
  const c = {
    selected: 'gradient',
  ...
  const config: MultilayerCircleProps = {
    globalConfig: {
      ...
      numberLabel: {
        ...
        seriesName: {
          ...
          prefix: {
            ...
            fontSize: 13,
            fontFamily: 'PingFangSC-Regular',
            labelSeriesNamePrefixColorFollow: true,
            color: 'yellow',
            fontWeight: 'normal'
          },
          suffix: {
            ...
            fontSize: 13,
            fontFamily: 'PingFangSC-Regular',
            labelSeriesNameSuffixColorFollow: false,
            color: '#c28411',
            fontWeight: 'normal'
          }
        }, // 系列名
    ...
    seriesConfig: {
      sort: 'diminishing', //"normal" | "diminishing" | "increasing" |
      dataSeries: [
        {
          map: {
            fieldName: '系列三',
  ...
  return (
    <div style={{ width: 900, height: 600, margin: ' 0 auto' }}>
      <LczMultilayerCircle w={900} h={600} data={data} {...config} onClick={a => console.log(a)} />
    </div>
  )
})
