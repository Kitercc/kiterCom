import { DrollParam, MapRange } from '../../LczChina2dMap/type'
import { FontStyle } from '../../LczNewsList/type'
import { AreaHeat, FlyLine, LightBar, Ripples, Scatter, Sign, Tooltip } from './child'
...
type Component = Ripples | Tooltip | Sign | AreaHeat | Scatter | FlyLine | LightBar
